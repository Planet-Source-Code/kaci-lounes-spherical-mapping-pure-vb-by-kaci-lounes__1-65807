 Spherical mapping in pure VB!, by KACI Lounes Mai/2006
 =====================================================
 ...
 This project can map any given texture in a circle
  that's give you a 'shperial mapping', you can use
   this for rendering cieling in a 3D scene as background
    for exemple.
 ...
 The code is written of a way that it is legible and
  understanding, and the programming is clearly
